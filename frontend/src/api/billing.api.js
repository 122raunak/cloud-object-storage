...
export const billingApi = {
  ...
  createPaymentOrder: (userId, invoiceId) => api.post(`/api/billing/pay/order/${userId}/${invoiceId}`),
  verifyPayment: (userId, invoiceId, data) => api.post(`/api/billing/pay/verify/${userId}/${invoiceId}`, data),
}